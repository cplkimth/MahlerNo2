/*
This file has been generated by Midnight Peach on 2019-10-02 오후 4:54:12.
...
namespace MahlerNo2.Data
{
    ...
    public partial class Emoticon : Entity<Emoticon>, IEntity
	{
		...
		public override string ToString()
		{
			...
			return "[EmoticonId]" + EmoticonId + ", " + "[At]" + At + ", " + "[Name]" + Name;
		}
    ...
    public partial class Log : Entity<Log>, IEntity
	{
		...
		public override string ToString()
		{
			...
			return "[LogId]" + LogId + ", " + "[At]" + At + ", " + "[Category]" + Category + ", " + "[Text]" + Text;
		}
	...
	/// <summary>
	/// Log 엔터티의 컬럼 이름을 상수 멤버로 가지고 있는 클래스
	/// </summary>
	public static class LogColumnName
	{
	...
	/// Log 데이터 클래스
	/// </summary>
	public partial class LogData : EntityData<Log>
	{
		internal LogData() {}
		...
		/// <returns>기본키가 일치하는 엔터티</returns>
		public virtual Log GetByPK(System.Int32 LogId)
		{
			using (var context = DbContextFactory.Create())
			{
		...
		/// </summary>
				/// <param name="logId">기본키</param>
		/// <returns>존재 여부</returns>
		public virtual bool ExistsByPK(System.Int32 LogId)
		{
			using (var context = DbContextFactory.Create())
			{
		...
		/// </summary>
				/// <param name="logId">기본키</param>
		/// <returns>예외 메시지. 성공이면 null</returns>
		public virtual string DeleteByPK(System.Int32 logId)
		{
			using (var context = DbContextFactory.Create())
			{
	...
	public partial class DataRepository : DataRepositoryBase
	{
		...
		{
						Emoticon = new EmoticonData();					Log = new LogData();					Shot = new ShotData();
		}

		#region Data objects
				public static EmoticonData Emoticon { get; private set; }				public static LogData Log { get; private set; }				public static ShotData Shot { get; private set; }
		#endregion
		}
	#endregion
